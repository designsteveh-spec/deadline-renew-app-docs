...
Subscriptions and in-app purchases are processed entirely by **Google Play**. **Refund eligibility, timing, and how to request a refund are governed by [Google Play’s refund policies](https://support.google.com/googleplay/answer/2479637)** and the laws that apply in your country.

In general:

- You may request a refund through **Google Play** (order history or Google’s refund request flow) within the periods Google allows
- Google decides refund eligibility for Play purchases according to its policies and local consumer law
- Canceling a subscription stops future renewals; it does not automatically refund past charges unless Google or applicable law provides otherwise
...
If you subscribed on another device or reinstalled the app, open **Upgrade** in the app and use **Restore purchases** (or equivalent) while signed into the **same Google account** used for the original purchase.

## Developer support

If you believe you were charged in error, were billed after canceling, or experienced a technical issue that prevented use of a paid feature, contact us with:

- Your **Google Play order ID** or transaction date
- The Google account email (if you are comfortable sharing it)
- A brief description of the issue

**Support email:** designstehev@gmail.com

We cannot issue refunds directly for Google Play charges. We will help where we can and may direct you to Google Play support when appropriate.

## Free tier

The free version of the app does not require payment. No refund applies to free use.
